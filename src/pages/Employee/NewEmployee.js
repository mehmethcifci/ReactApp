...
export default function NewEmployee() {
  ...
  const submit = (e) => {
    ...
    data.employeeNumber !== "" && data.address !== "" && data.phone !== "" && data.mail !== "" && data.foundingDate !== "" && data.photo !== ""&& data.identificationNumber !== ""){
    Axios.post("http://104.197.73.6:8081/v1/api/user/newemployee",  {
    companyId: -1,
    photo: "",
    name: "",
    lastName:"",
          ...
          <div className="breadcrumb-path ">
            <ul className="breadcrumb">
              <li className="breadcrumb-item">
                <a href="/company">
                <img src="assets/img/dash.png"  className="mr-2" alt="breadcrumb" />
                  New Employee
                </a>
              </li>
            </ul>
            ...
            <div className="form-creation">
              ...
              <form onSubmit={(e) => submit(e)}>
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-sm-12 col-12 ">
                      <label>Work End Date <span className="mandatory">*</span>{""}</label>
                      <input className="form-control"
                      id="workEndDate"
                          type="date"
                          onChange={(e) => handleText(e)}
                ...
                <div className="row">
                  ...
                  <div className="col-xl-6 col-sm-12 col-12 ">
                      ...
                      <label>Identification Number <span className="mandatory">*</span>{""}</label>
                      <input
                        className="form-control"
                        type="tel"
